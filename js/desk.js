...
(function () {
  ...
  const PRESETS = [
    { label: "메일 다듬기(11강)", sit: "미뤄둔 메일 답장을 써야 하는데", aud: "거래처 담당자에게", shape: "정중한 존댓말로, 3문단 이내",
      variants: {
        owner: { sit: "별점 2점 리뷰에 답글을 써야 하는데", aud: "불만 손님에게", shape: "사과와 개선 약속을 담아 변명 없이 3문장" },
        student: { sit: "과제 기한 연장을 부탁드려야 하는데", aud: "담당 교수님께", shape: "정중한 존댓말로, 3문장 이내" }
      } },
    { label: "요약 요청(12강)", sit: "긴 회의록을 받았는데 핵심만 알고 싶어요", aud: "나 혼자 보려고", shape: "핵심 3줄 요약으로",
      variants: {
        owner: { sit: "지원사업 공고문을 받았는데 핵심만 알고 싶어요", aud: "혼자 확인하려고", shape: "신청 자격·기한·서류를 표로" },
        student: { sit: "긴 논문 한 편을 받았는데 핵심만 알고 싶어요", aud: "발표 준비하려고", shape: "핵심 3줄 + 예상 질문으로" }
      } },
    { label: "아이디어 벽치기(13강)", sit: "다음 회의 전에 예상 질문을 준비해야 하는데", aud: "팀 회의에서 쓰려고", shape: "예상 질문 10개 리스트로",
      variants: {
        owner: { sit: "다음 시즌 신메뉴 아이디어가 필요한데", aud: "가게에 새로 걸 메뉴를 정하려고", shape: "후보 10개 리스트로" },
        student: { sit: "다음 팀플 발표 주제 후보가 필요한데", aud: "조모임에서 쓰려고", shape: "발표 예상 질문 10개 리스트로" }
      } }
  ];
  ...
  const BUILD_PLACEHOLDERS = {
    ...
    student: { sit: "교수님께 과제 기한 연장을 부탁드려야 하는데", aud: "담당 교수님께", shape: "정중하지만 짧게, 3문장 안으로" }
  };
